...
def load_dataset(n, sample_size=3000, seed=42):
    data_satellite = np.load("/Users/ccristiano/Documents/Codigos/QML/Satellite/qutrit/distr_sol_pv_segm_embeddings_v2.npz", allow_pickle=True)
...
#     LAYERS       = 6
#     LR           = 0.006
#     SAVE_DIR = "/Users/ccristiano/Documents/Codigos/QML/Wine/qutrit/data/4params_sum"
...
if __name__ == "__main__":
    ...
    LAYERS     = 6
    LR         = 0.006
    SAVE_DIR = "/Users/camila/Documents/QML/Satellite/qutrit/data/4params_sum"
    ...
    for NUM_FEATURES in range(4, 9):    # 4,5,6,7,8
        ...
        X, y, exp_var = load_dataset(NUM_FEATURES, sample_size=700, seed=42)
        X_train, X_test, y_train, y_test = train_test_split(
            X, y, test_size=0.2, stratify=y, random_state=42
        )
        train_dl = DataLoader(CustomDataset(X_train, y_train),
...
#     # Probar diferentes NUM_PARAMS
#     for NUM_PARAMS in range(4, 9):  # 4,5,6,7,8
#         SAVE_DIR = "/Users/camila/Documents/QML/Satellite/qutrit/data/4params_sum"
#         os.makedirs(SAVE_DIR, exist_ok=True)

#         print("\n" + "#"*60)
#         print(f"🚀 Entrenando con NUM_PARAMS = {NUM_PARAMS}")
#         print("#"*60)
...
#             total_time = time.perf_counter() - global_start
#             print(f"⏱ Tiempo total para NUM_FEATURES={NUM_FEATURES}, "
#                   f"NUM_PARAMS={NUM_PARAMS}: {total_time/60:.2f} min")
...
LR           = 0.0001
NUM_FEATURES = 8
BASE_SAVE_DIR = f"/Users/ccristiano/Documents/Codigos/QML/Satellite/qutrit/data/4params_sum_3"
