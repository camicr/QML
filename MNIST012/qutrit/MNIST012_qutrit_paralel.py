...
def load_dataset(n_components):
    ...
    # 012 ---------------------------------------------
    zeros_x = digits["images"][digits["target"]==0]
    ones_x  = digits["images"][digits["target"]==1]
    twos_x  = digits["images"][digits["target"]==2]

    zeros_y  = digits["target"][digits["target"]==0]
    ones_y   = digits["target"][digits["target"]==1]
    twos_y = digits["target"][digits["target"]==2]

    x_data = np.vstack((zeros_x, ones_x))
    x_data = np.vstack((x_data, twos_x))

    y_data = np.hstack((zeros_y, ones_y))
...
#     LAYERS       = 6
#     LR           = 0.006
#     SAVE_DIR = "/Users/ccristiano/Documents/Codigos/QML/MNIST012/qutrit/data/4params_sum"
...
# LR           = 0.0001
# NUM_FEATURES = 8
# BASE_SAVE_DIR = f"/Users/ccristiano/Documents/Codigos/QML/Wine/qutrit/data/4params_sum_3"
