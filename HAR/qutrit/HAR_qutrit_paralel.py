...
def load_dataset(data_path, n_features, seed):
    ...
    # Si necesitás estrictamente [-1,1] en test:
    # import numpy as np
    # X_test_final = np.clip(X_test_final, -1.0, 1.0)
...
if __name__ == "__main__":
    ...
    LAYERS     = 6
    LR         = 0.006
    SAVE_DIR = "/Users/ccristiano/Documents/Codigos/QML/HAR/qutrit/data/params_sum"
    ...
    for NUM_FEATURES in range(4, 9):    # 4,5,6,7,8
        ...
        X_train, y_train, X_test, y_test, var_ratio = load_dataset(data_path, NUM_FEATURES, 42)
...
LR           = 0.0005
NUM_FEATURES = 8
BASE_SAVE_DIR = f"/Users/ccristiano/Documents/Codigos/QML/MNIST345/qutrit/data/4param_sum"
os.makedirs(BASE_SAVE_DIR, exist_ok=True)

# dataset (lo mismo que antes)
data_path = "/Users/ccristiano/Documents/Codigos/QML/HAR/UCI HAR Dataset"
X_train, y_train, X_test, y_test, var_ratio = load_dataset(data_path, NUM_FEATURES)
